...
#      puts "comparing #{file1[:base]} with #{file2[:base]} "
      dedupe_pair(file1,file2)
    end
  end

end

def dedupe_pair(file1,file2)

  if file1[:base].size < file2[:base].size
    dedupe_ordered_pair(file1,file2)
  else
    dedupe_ordered_pair(file2,file1)
  end

end

def dedupe_ordered_pair(file1,file2)
